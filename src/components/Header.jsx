...
function Header(){
    ...
    const {input,setinput,fetchpost,page,setpage,searched}=useContext(AppContext)
    ...
    return(
        <div className="flex justify-between px-3 py-2 bg-sky-900 items-center text-white">
            ...
            <h1 className="font-bold font-size-[30px]">Movie</h1>
            </div>

           
            <div className="border-white border-2 h-[40px] flex bg-white items-center max-w-[600px]">
                <input type="text" className=" border-none outline-none text-black h-full px-3 py-2 bg-transperent w-full" placeholder="Enter movie name" onChange={changehandler} value={input}></input>
                ...
                }><IoSearch className="text-black text-xl" /></span> 
            </div>
        </div>
    )
}
